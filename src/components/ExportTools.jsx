...
export default function ExportTools({ repository, data }) {
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      pdf.text(`DevOrbit Analytics Report`, pageWidth / 2, yPosition, { align: 'center' })
      yPosition += 10
      ...
      pdf.text('Generated by DevOrbit - GitHub Analytics Dashboard', pageWidth / 2, pdf.internal.pageSize.getHeight() - 10, { align: 'center' })
